...
function filelist2($ee, $urls,$xurls,$index,$path,$url,$proto,$port,$fcombo,$fileid) {
global $baseurl;
...
$kk=filelist($ee, $urls,$xurls,$index,$path,$url,$proto,$port);
if ($kk[0]) {$urls.=$kk[1];$xurls.="img\n";$index++;$text.=$fcombo."?fileid=".$fileid."&index=".$index."&type=img".$size;}
else if (startsWith(strToLower($kk[1]),"data:image")) {$text=$kk[1].$size;}
else {$text.=$fcombo."?fileid=".$fileid."&index=".$kk[2]."&type=img".$size;}
$text.=", ";
...
function filelist($ee, $urls,$xurls,$index,$path,$url,$proto,$port) {
global $baseurl;
$test="";
$ee=trimcssimages($ee);
debugmode("filelist","start",$index." ".strlen($urls)." ".$ee." ".$proto." ".$url." ".$port." ".$path."<br>");

if (startsWith(strtolower($ee),"https://") || startsWith(strtolower($ee),"http://")) {$test=$ee."\n";}
else if(startsWith(strToLower($ee),"data:image")) {$test=$ee;$result=false;$index=$index;$zzz[0]=$result;$zzz[1]=$test;$zzz[2]=$index;return $zzz;}
...
//echo "<br>testing:".$test;
//echo "<br>base:".strToLower($baseurl);
//echo "<br>base2:".strToLower($baseurl2);
//echo "<br>compare:".(strToLower($test)===strToLower($baseurl))." ".strlen($test)." ".strlen($baseurl)." ".substr($test,0,2)." ".substr($test,61,63)." ".endsWith($test," ");


//echo "<br>compare:".startsWith(strToLower($test),strToLower($baseurl));
//echo "<br>compare:".startsWith(strToLower($test),strToLower($baseurl2."?lang"));
if(strToLower($test)===strToLower($baseurl)."\n") {$test=$baseurl;}
...
if ((!(strpos($urls,"\n".$test)!== FALSE)) && (strToLower($test)!==strToLower($baseurl)))
 {$result=true;}  //if new, return true;

else {
$temp=explode("\n",$urls);
$a=0;
//debugmode("filelist",1000,count($temp));

if (strToLower($test)===strToLower($baseurl))  {//echo "<br>foundone<br>";
$index=0;} else {
for($a=0;$a<count($temp);$a++) {
if($temp[$a]."\n"===$test) {//echo "<br>foundone<br>";
$index=$a-1;break;}}}//end if/for/if
}//end else
$zzz[0]=$result;$zzz[1]=$test;$zzz[2]=$index;
...
function parsedata($ll,$proto,$url,$port,$path,$index,$fcombo,$fileid,$urls,$xurls,$doreplace,$iscss1, $istwitter,$isvideo) {
global $video;
global $videocount;
if (strpos($ll,"\x08")!==false) {$doreplace=false;$zzz[0]=$urls;$zzz[1]=$ll;$zzz[2]=$index;$zzz[3]=$xurls;return $zzz;}
...
if (startsWith(strtolower($cc[$dd]),"script") && !$commentopen) {$scriptopen=true;}
     ...
     if (strpos(strtolower($ee)," src=\"")>0) {$ee=substr($ee,  strpos(strtolower($ee)," src=\"")+6);$tmp1=substr($cc[$dd],0,strlen($tmp2)-strlen($ee));$tmp2=$ee;$ee=substr($ee,0,strpos($ee,"\""));$tmp3=substr($tmp2,strpos($tmp2,"\"")).$tmp3;$tmp2=$ee;$kk=filelist($ee, $urls,$xurls,$index,$path,$c_url,$c_proto,$c_port); if ($kk[0]) {$urls.=$kk[1];$xurls.=(startsWith($cc[$dd],"s")?"src\n":"img\n");$index++;$tmp2=$fcombo."?fileid=".$fileid."&index=".$index."&type=".(startsWith($cc[$dd],"s")?"src":"img");} else if (startsWith(strToLower($kk[1]),"data:image")) {$tmp2=$kk[1];} else {$tmp2=$fcombo."?fileid=".$fileid."&index=".$kk[2]."&type=".(startsWith($cc[$dd],"s")?"src":"img");}}
else if (strpos(strtolower($ee)," src='")>0)  {$ee=substr($ee,  strpos(strtolower($ee)," src='")+6);$tmp1=substr($cc[$dd],0,strlen($tmp2)-strlen($ee));$tmp2=$ee; $ee=substr($ee,0,strpos($ee,"'"));$tmp3=substr($tmp2,strpos($tmp2,"'")).$tmp3;$tmp2=$ee;$kk=filelist($ee, $urls,$xurls,$index,$path,$c_url,$c_proto,$c_port); if ($kk[0]) {$urls.=$kk[1];$xurls.=(startsWith($cc[$dd],"s")?"src\n":"img\n");$index++;$tmp2=$fcombo."?fileid=".$fileid."&index=".$index."&type=".(startsWith($cc[$dd],"s")?"src":"img");} else if (startsWith(strToLower($kk[1]),"data:image")) {$tmp2=$kk[1];} else {$tmp2=$fcombo."?fileid=".$fileid."&index=".$kk[2]."&type=".(startsWith($cc[$dd],"s")?"src":"img");}}
else if (strpos(strtolower($ee)," src=")>0)   {$ee=substr($ee,0,strpos(strtolower($ee)," src=")+5);$tmp1=substr($cc[$dd],0,strlen($tmp2)-strlen($ee));$tmp2=$ee;if (strpos($ee," ")>0)                                        {$ee=substr($ee,0,strpos($ee," "));$tmp3=substr($tmp2,strpos($tmp2," ")).$tmp3;$tmp2=$ee;} else {$ee=substr($ee,0,strlen($ee)-1);$tmp3=substr($tmp2,strpos(" ")).$tmp3;$tmp2=$ee;}$kk=filelist($ee, $urls,$xurls,$index,$path,$c_url,$c_proto,$c_port); if ($kk[0]) {$urls.=$kk[1];$xurls.=(startsWith($cc[$dd],"s\n")?"src":"img\n");$index++;$tmp2=$fcombo."?fileid=".$fileid."&index=".$index."&type=".(startsWith($cc[$dd],"s")?"src":"img");} else if (startsWith(strToLower($kk[1]),"data:image")) {$tmp2=$kk[1];} else {$tmp2=$fcombo."?fileid=".$fileid."&index=".$kk[2]."&type=".(startsWith($cc[$dd],"s")?"src":"img");}}
...
$ee=substr($cc[$dd],0,strpos($cc[$dd],">"));$tmp2=$ee;$tmp3=substr($cc[$dd],strpos($cc[$dd],">"));$tmp1="";
     if (strpos(strtolower($ee)," srcset=\"")>0) {$ee=substr($ee,  strpos(strtolower($ee)," srcset=\"")+9);$tmp1=substr($cc[$dd],0,strlen($tmp2)-strlen($ee));$tmp2=$ee;$ee=substr($ee,0,strpos($ee,"\""));$tmp3=substr($tmp2,strpos($tmp2,"\"")).$tmp3;$tmp2=$ee;$kk=filelist2($ee, $urls,$xurls,$index,$path,$c_url,$c_proto,$c_port,$fcombo,$fileid);$urls=$kk[0];$tmp2=$kk[1];$index=$kk[2];$xurls=$kk[3];}
else if (strpos(strtolower($ee)," srcset='")>0)  {$ee=substr($ee,  strpos(strtolower($ee)," srcset='")+9);$tmp1=substr($cc[$dd],0,strlen($tmp2)-strlen($ee));$tmp2=$ee; $ee=substr($ee,0,strpos($ee,"'"));$tmp3=substr($tmp2,strpos($tmp2,"'")).$tmp3;$tmp2=$ee;$kk=filelist2($ee, $urls,$xurls,$index,$path,$c_url,$c_proto,$c_port,$fcombo,$fileid);$urls=$kk[0];$tmp2=$kk[1];$index=$kk[2];$xurls=$kk[3];}
else if (strpos(strtolower($ee)," srcset=")>0)   {$ee=substr($ee,0,strpos(strtolower($ee)," srcset=")+8);$tmp1=substr($cc[$dd],0,strlen($tmp2)-strlen($ee));$tmp2=$ee;if (strpos($ee," ")>0)                                        {$ee=substr($ee,0,strpos($ee," "));$tmp3=substr($tmp2,strpos($tmp2," ")).$tmp3;$tmp2=$ee;} else {$ee=substr($ee,0,strlen($ee)-1);$tmp3=substr($tmp2,strpos(" ")).$tmp3;$tmp2=$ee;}$kk=filelist2($ee, $urls,$xurls,$index,$path,$c_url,$c_proto,$c_port,$fcombo,$fileid);$urls=$kk[0];$tmp2=$kk[1];$index=$kk[2];$xurls=$kk[3];}

}

if (startsWith(strtolower($cc[$dd]),"audio ")) {$ee=substr($cc[$dd],0,strpos($cc[$dd],">"));$tmp2=$ee;$tmp3=substr($cc[$dd],strpos($cc[$dd],">"));
     if (strpos(strtolower($ee)," src=\"")>0) {$ee=substr($ee,  strpos(strtolower($ee)," src=\"")+6);$tmp1=substr($cc[$dd],0,strlen($tmp2)-strlen($ee));$tmp2=$ee;$ee=substr($ee,0,strpos($ee,"\""));$tmp3=substr($tmp2,strpos($tmp2,"\"")).$tmp3;$tmp2=$ee;$kk=filelist($ee, $urls,$xurls,$index,$path,$c_url,$c_proto,$c_port); if ($kk[0]) {$urls.=$kk[1];$xurls.="snd\n";$index++;$tmp2=$fcombo."?fileid=".$fileid."&index=".$index."&type=snd";} else {$tmp2=$fcombo."?fileid=".$fileid."&index=".$kk[2]."&type=snd";}}
else if (strpos(strtolower($ee)," src='")>0)  {$ee=substr($ee,  strpos(strtolower($ee)," src='")+6);$tmp1=substr($cc[$dd],0,strlen($tmp2)-strlen($ee));$tmp2=$ee; $ee=substr($ee,0,strpos($ee,"'"));$tmp3=substr($tmp2,strpos($tmp2,"'")).$tmp3;$tmp2=$ee;$kk=filelist($ee, $urls,$xurls,$index,$path,$c_url,$c_proto,$c_port); if ($kk[0]) {$urls.=$kk[1];;$xurls.="snd\n";$index++;$tmp2=$fcombo."?fileid=".$fileid."&index=".$index."&type=snd";} else {$tmp2=$fcombo."?fileid=".$fileid."&index=".$kk[2]."&type=snd";}}
else if (strpos(strtolower($ee)," src=")>0)   {$ee=substr($ee,0,strpos(strtolower($ee)," src=")+5);$tmp1=substr($cc[$dd],0,strlen($tmp2)-strlen($ee));$tmp2=$ee;if (strpos($ee," ")>0)                                        {$ee=substr($ee,0,strpos($ee," "));$tmp3=substr($tmp2,strpos($tmp2," ")).$tmp3;$tmp2=$ee;} else {$ee=substr($ee,0,strlen($ee)-1);$tmp3=substr($tmp2,strpos(" ")).$tmp3;$tmp2=$ee;}$kk=filelist($ee, $urls,$xurls,$index,$path,$c_url,$c_proto,$c_port); if ($kk[0]) {$urls.=$kk[1];$xurls.="snd\n";$index++;$tmp2=$fcombo."?fileid=".$fileid."&index=".$index."&type=vid";} else {$tmp2=$fcombo."?fileid=".$fileid."&index=".$kk[2]."&type=snd";}}
}

if (startsWith(strtolower($cc[$dd]),"embed ")) {$ee=substr($cc[$dd],0,strpos($cc[$dd],">"));$tmp2=$ee;$tmp3=substr($cc[$dd],strpos($cc[$dd],">"));
     if (strpos(strtolower($ee)," src=\"")>0) {$ee=substr($ee,  strpos(strtolower($ee)," src=\"")+6);$tmp1=substr($cc[$dd],0,strlen($tmp2)-strlen($ee));$tmp2=$ee;$ee=substr($ee,0,strpos($ee,"\""));$tmp3=substr($tmp2,strpos($tmp2,"\"")).$tmp3;$tmp2=$ee;$kk=filelist($ee, $urls,$xurls,$index,$path,$c_url,$c_proto,$c_port); if ($kk[0]) {$urls.=$kk[1];$xurls.="emb\n";$index++;$tmp2=$fcombo."?fileid=".$fileid."&index=".$index."&type=emb";} else {$tmp2=$fcombo."?fileid=".$fileid."&index=".$kk[2]."&type=emb";}}
else if (strpos(strtolower($ee)," src='")>0)  {$ee=substr($ee,  strpos(strtolower($ee)," src='")+6);$tmp1=substr($cc[$dd],0,strlen($tmp2)-strlen($ee));$tmp2=$ee; $ee=substr($ee,0,strpos($ee,"'"));$tmp3=substr($tmp2,strpos($tmp2,"'")).$tmp3;$tmp2=$ee;$kk=filelist($ee, $urls,$xurls,$index,$path,$c_url,$c_proto,$c_port); if ($kk[0]) {$urls.=$kk[1];$xurls.="emb\n";$index++;$tmp2=$fcombo."?fileid=".$fileid."&index=".$index."&type=emb";} else {$tmp2=$fcombo."?fileid=".$fileid."&index=".$kk[2]."&type=emb";}}
else if (strpos(strtolower($ee)," src=")>0)   {$ee=substr($ee,0,strpos(strtolower($ee)," src=")+5);$tmp1=substr($cc[$dd],0,strlen($tmp2)-strlen($ee));$tmp2=$ee;if (strpos($ee," ")>0)                                        {$ee=substr($ee,0,strpos($ee," "));$tmp3=substr($tmp2,strpos($tmp2," ")).$tmp3;$tmp2=$ee;} else {$ee=substr($ee,0,strlen($ee)-1);$tmp3=substr($tmp2,strpos(" ")).$tmp3;$tmp2=$ee;}$kk=filelist($ee, $urls,$xurls,$index,$path,$c_url,$c_proto,$c_port); if ($kk[0]) {$urls.=$kk[1];$xurls.="emb\n";$index++;$tmp2=$fcombo."?fileid=".$fileid."&index=".$index."&type=vid";} else {$tmp2=$fcombo."?fileid=".$fileid."&index=".$kk[2]."&type=emb";}}
}

if (startsWith(strtolower($cc[$dd]),"applet ")) {$ee=substr($cc[$dd],0,strpos($cc[$dd],">"));$tmp2=$ee;$tmp3=substr($cc[$dd],strpos($cc[$dd],">"));
     if (strpos(strtolower($ee)," code=\"")>0) {$ee=substr($ee,  strpos(strtolower($ee)," code=\"")+7);$tmp1=substr($cc[$dd],0,strlen($tmp2)-strlen($ee));$tmp2=$ee;$ee=substr($ee,0,strpos($ee,"\""));$tmp3=substr($tmp2,strpos($tmp2,"\"")).$tmp3;$tmp2=$ee;$kk=filelist($ee, $urls,$xurls,$index,$path,$c_url,$c_proto,$c_port); if ($kk[0]) {$urls.=$kk[1];$xurls.="java\n";$index++;$tmp2=$fcombo."?fileid=".$fileid."&index=".$index."&type=java";} else {$tmp2=$fcombo."?fileid=".$fileid."&index=".$kk[2]."&type=java";}}
else if (strpos(strtolower($ee)," code='")>0)  {$ee=substr($ee,  strpos(strtolower($ee)," code='")+7);$tmp1=substr($cc[$dd],0,strlen($tmp2)-strlen($ee));$tmp2=$ee; $ee=substr($ee,0,strpos($ee,"'"));$tmp3=substr($tmp2,strpos($tmp2,"'")).$tmp3;$tmp2=$ee;$kk=filelist($ee, $urls,$xurls,$index,$path,$c_url,$c_proto,$c_port); if ($kk[0]) {$urls.=$kk[1];$xurls.="java\n";$index++;$tmp2=$fcombo."?fileid=".$fileid."&index=".$index."&type=java";} else {$tmp2=$fcombo."?fileid=".$fileid."&index=".$kk[2]."&type=java";}}
else if (strpos(strtolower($ee)," code=")>0)   {$ee=substr($ee,0,strpos(strtolower($ee)," code=")+6);$tmp1=substr($cc[$dd],0,strlen($tmp2)-strlen($ee));$tmp2=$ee;if (strpos($ee," ")>0)                                        {$ee=substr($ee,0,strpos($ee," "));$tmp3=substr($tmp2,strpos($tmp2," ")).$tmp3;$tmp2=$ee;} else {$ee=substr($ee,0,strlen($ee)-1);$tmp3=substr($tmp2,strpos(" ")).$tmp3;$tmp2=$ee;}$kk=filelist($ee, $urls,$xurls,$index,$path,$c_url,$c_proto,$c_port); if ($kk[0]) {$urls.=$kk[1];$xurls.="java\n";$index++;$tmp2=$fcombo."?fileid=".$fileid."&index=".$index."&type=java";} else {$tmp2=$fcombo."?fileid=".$fileid."&index=".$kk[2]."&type=java";}}
}

if (startsWith(strtolower($cc[$dd]),"video ")) {$ee=substr($cc[$dd],0,strpos($cc[$dd],">"));$tmp2=$ee;$tmp3=substr($cc[$dd],strpos($cc[$dd],">"));
echo "video found";
     if (strpos(strtolower($ee)," src=\"")>0) {$ee=substr($ee,  strpos(strtolower($ee)," src=\"")+6);$tmp1=substr($cc[$dd],0,strlen($tmp2)-strlen($ee));$tmp2=$ee;$ee=substr($ee,0,strpos($ee,"\""));$tmp3=substr($tmp2,strpos($tmp2,"\"")).$tmp3;$tmp2=$ee;$kk=filelist($ee, $urls,$xurls,$index,$path,$c_url,$c_proto,$c_port); if ($kk[0]) {$urls.=$kk[1];;$xurls.="vid\n";$index++;$tmp2=$fcombo."?fileid=".$fileid."&index=".$index."&type=vid";} else {$tmp2=$fcombo."?fileid=".$fileid."&index=".$kk[2]."&type=vid";}}
else if (strpos(strtolower($ee)," src='")>0)  {$ee=substr($ee,  strpos(strtolower($ee)," src='")+6);$tmp1=substr($cc[$dd],0,strlen($tmp2)-strlen($ee));$tmp2=$ee; $ee=substr($ee,0,strpos($ee,"'"));$tmp3=substr($tmp2,strpos($tmp2,"'")).$tmp3;$tmp2=$ee;$kk=filelist($ee, $urls,$xurls,$index,$path,$c_url,$c_proto,$c_port); if ($kk[0]) {$urls.=$kk[1];$xurls.="vid\n";$index++;$tmp2=$fcombo."?fileid=".$fileid."&index=".$index."&type=vid";} else {$tmp2=$fcombo."?fileid=".$fileid."&index=".$kk[2]."&type=vid";}}
else if (strpos(strtolower($ee)," src=")>0)   {$ee=substr($ee,0,strpos(strtolower($ee)," src=")+5);$tmp1=substr($cc[$dd],0,strlen($tmp2)-strlen($ee));$tmp2=$ee;if (strpos($ee," ")>0)                                        {$ee=substr($ee,0,strpos($ee," "));$tmp3=substr($tmp2,strpos($tmp2," ")).$tmp3;$tmp2=$ee;} else {$ee=substr($ee,0,strlen($ee)-1);$tmp3=substr($tmp2,strpos(" ")).$tmp3;$tmp2=$ee;}$kk=filelist($ee, $urls,$xurls,$index,$path,$c_url,$c_proto,$c_port); if ($kk[0]) {$urls.=$kk[1];$xurls.="vid\n";$index++;$tmp2=$fcombo."?fileid=".$fileid."&index=".$index."&type=vid";} else {$tmp2=$fcombo."?fileid=".$fileid."&index=".$kk[2]."&type=vid";}}
if ($tmp1.$tmp2.$tmp3===$tmp) {} else {$cc[$dd]=$tmp1.$tmp2.$tmp3;}
$tmp1="";$tmp2="";$tmp3=$cc[$dd];
$ee=substr($cc[$dd],0,strpos($cc[$dd],">"));$tmp2=$ee;$tmp3=substr($cc[$dd],strpos($cc[$dd],">"));$tmp1="";
     if (strpos(strtolower($ee)," poster=\"")>0) {$ee=substr($ee,  strpos(strtolower($ee)," poster=\"")+9);$tmp1=substr($cc[$dd],0,strlen($tmp2)-strlen($ee));$tmp2=$ee;$ee=substr($ee,0,strpos($ee,"\""));$tmp3=substr($tmp2,strpos($tmp2,"\"")).$tmp3;$tmp2=$ee;$kk=filelist($ee, $urls,$xurls,$index,$path,$c_url,$c_proto,$c_port); if ($kk[0]) {$urls.=$kk[1];$xurls.="img\n";$index++;$tmp2=$fcombo."?fileid=".$fileid."&index=".$index."&type=img";} else {$tmp2=$fcombo."?fileid=".$fileid."&index=".$kk[2]."&type=img";}}
else if (strpos(strtolower($ee)," poster='")>0)  {$ee=substr($ee,  strpos(strtolower($ee)," poster='")+9);$tmp1=substr($cc[$dd],0,strlen($tmp2)-strlen($ee));$tmp2=$ee; $ee=substr($ee,0,strpos($ee,"'"));$tmp3=substr($tmp2,strpos($tmp2,"'")).$tmp3;$tmp2=$ee;$kk=filelist($ee, $urls,$xurls,$index,$path,$c_url,$c_proto,$c_port); if ($kk[0]) {$urls.=$kk[1];;$xurls.="img\n";$index++;$tmp2=$fcombo."?fileid=".$fileid."&index=".$index."&type=img";} else {$tmp2=$fcombo."?fileid=".$fileid."&index=".$kk[2]."&type=img";}}
else if (strpos(strtolower($ee)," poster=")>0)   {$ee=substr($ee,0,strpos(strtolower($ee)," poster=")+8);$tmp1=substr($cc[$dd],0,strlen($tmp2)-strlen($ee));$tmp2=$ee;if (strpos($ee," ")>0)                                        {$ee=substr($ee,0,strpos($ee," "));$tmp3=substr($tmp2,strpos($tmp2," ")).$tmp3;$tmp2=$ee;} else {$ee=substr($ee,0,strlen($ee)-1);$tmp3=substr($tmp2,strpos(" ")).$tmp3;$tmp2=$ee;}$kk=filelist($ee, $urls,$xurls,$index,$path,$c_url,$c_proto,$c_port); if ($kk[0]) {$urls.=$kk[1];$xurls.="img\n";$index++;$tmp2=$fcombo."?fileid=".$fileid."&index=".$index."&type=img";} else {$tmp2=$fcombo."?fileid=".$fileid."&index=".$kk[2]."&type=img";}}
}
...
else if (strpos(strtolower($ee)," src='")>0)  {$ee=substr($ee,  strpos(strtolower($ee)," src='")+6);$tmp1=substr($cc[$dd],0,strlen($tmp2)-strlen($ee));$tmp2=$ee; $ee=substr($ee,0,strpos($ee,"'"));$tmp3=substr($tmp2,strpos($tmp2,"'")).$tmp3;$tmp2=$ee;$kk=filelist($ee, $urls,$xurls,$index,$path,$c_url,$c_proto,$c_port); if ($kk[0]) {$urls.=$kk[1];"vid\n";$index++;$tmp2="loadfile.php?fileid=".$fileid."&index=".$index."&type=vid";} else {$tmp2="loadfile.php?fileid=".$fileid."&index=".$kk[2]."&type=vid";}}
...
else {$ee=substr($ee,0,strlen($ee)-1);$tmp3=substr($tmp2,strpos(" ")).$tmp3;$tmp2=$ee;}$kk=filelist($ee, $urls,$xurls,$index,$path,$c_url,$c_proto,$c_port); if ($kk[0]) {$urls.=$kk[1];$xurls.="vid\n";$index++;$tmp2="loadfile.php?fileid=".$fileid."&index=".$index."&type=vid";} else {$tmp2="loadfile.php?fileid=".$fileid."&index=".$kk[2]."&type=vid";}}
...
//else {$ee=substr($ee,0,strlen($ee)-1);$tmp3=substr($tmp2,strpos(" ")).$tmp3;$tmp2=$ee;}$kk=filelist($ee, $urls,$xurls,$index,$path,$c_url,$c_proto,$c_port); if ($kk[0]) {$urls.=$kk[1];$xurls.="vid\n";$index++;$tmp2=$finalurl."/php/".$fileid."/".$index.".mp4";} else {$tmp2=$finalurl."/php/".$fileid."/".$index.".mp4";}}
     ...
     if (strpos(strtolower($ee)," src=\"")>0) {$ee=substr($ee,  strpos(strtolower($ee)," src=\"")+6);$tmp1=substr($cc[$dd],0,strlen($tmp2)-strlen($ee));$tmp2=$ee;$ee=substr($ee,0,strpos($ee,"\""));$tmp3=substr($tmp2,strpos($tmp2,"\"")).$tmp3;$tmp2=$ee;$kk=filelist($ee, $urls,$xurls,$index,$path,$c_url,$c_proto,$c_port); if ($kk[0]) {$urls.=$kk[1];$xurls.=gettype3($kk[1])."\n";$index++;$tmp2=$fcombo."?fileid=".$fileid."&index=".$index."&type=".gettype3($kk[1]);} else {$tmp2=$fcombo."?fileid=".$fileid."&index=".$kk[2]."&type=".gettype3($kk[1]);}}
else if (strpos(strtolower($ee)," src='")>0)  {$ee=substr($ee,  strpos(strtolower($ee)," src='")+6);$tmp1=substr($cc[$dd],0,strlen($tmp2)-strlen($ee));$tmp2=$ee; $ee=substr($ee,0,strpos($ee,"'"));$tmp3=substr($tmp2,strpos($tmp2,"'")).$tmp3;$tmp2=$ee;$kk=filelist($ee, $urls,$xurls,$index,$path,$c_url,$c_proto,$c_port); if ($kk[0]) {$urls.=$kk[1];;$xurls.=gettype3($kk[1])."\n";$index++;$tmp2=$fcombo."?fileid=".$fileid."&index=".$index."&type=".gettype3($kk[1]);} else {$tmp2=$fcombo."?fileid=".$fileid."&index=".$kk[2]."&type=".gettype3($kk[1]);}}
else if (strpos(strtolower($ee)," src=")>0)   {$ee=substr($ee,0,strpos(strtolower($ee)," src=")+5);$tmp1=substr($cc[$dd],0,strlen($tmp2)-strlen($ee));$tmp2=$ee;if (strpos($ee," ")>0)                                        
{$ee=substr($ee,0,strpos($ee," "));$tmp3=substr($tmp2,strpos($tmp2," ")).$tmp3;$tmp2=$ee;} 
else {$ee=substr($ee,0,strlen($ee)-1);$tmp3=substr($tmp2,strpos(" ")).$tmp3;$tmp2=$ee;}$kk=filelist($ee, $urls,$xurls,$index,$path,$c_url,$c_proto,$c_port); if ($kk[0]) {$urls.=$kk[1];$xurls.=gettype3($kk[1])."\n";$index++;$tmp2=$fcombo."?fileid=".$fileid."&index=".$index."&type=".gettype3($kk[1]);} else {$tmp2=$fcombo."?fileid=".$fileid."&index=".$kk[2]."&type=".gettype3($kk[1]);}}
}

if (startsWith(strtolower($cc[$dd]),"source ")) {$ee=substr($cc[$dd],0,strpos($cc[$dd],">"));$tmp2=$ee;$tmp3=substr($cc[$dd],strpos($cc[$dd],">"));
     if (strpos(strtolower($ee)," src=\"")>0) {$ee=substr($ee,  strpos(strtolower($ee)," src=\"")+6);$tmp1=substr($cc[$dd],0,strlen($tmp2)-strlen($ee));$tmp2=$ee;$ee=substr($ee,0,strpos($ee,"\""));$tmp3=substr($tmp2,strpos($tmp2,"\"")).$tmp3;$tmp2=$ee;$kk=filelist($ee, $urls,$xurls,$index,$path,$c_url,$c_proto,$c_port); if ($kk[0]) {$urls.=$kk[1];$xurls.=gettype2($tmp3)."\n";$index++;$tmp2=$fcombo."?fileid=".$fileid."&index=".$index."&type=".gettype2($tmp3);} else {$tmp2=$fcombo."?fileid=".$fileid."&index=".$kk[2]."&type=".gettype2($tmp3);}}
else if (strpos(strtolower($ee)," src='")>0)  {$ee=substr($ee,  strpos(strtolower($ee)," src='")+6);$tmp1=substr($cc[$dd],0,strlen($tmp2)-strlen($ee));$tmp2=$ee; $ee=substr($ee,0,strpos($ee,"'"));$tmp3=substr($tmp2,strpos($tmp2,"'")).$tmp3;$tmp2=$ee;$kk=filelist($ee, $urls,$xurls,$index,$path,$c_url,$c_proto,$c_port); if ($kk[0]) {$urls.=$kk[1];$xurls.=gettype2($tmp3)."\n";$index++;$tmp2=$fcombo."?fileid=".$fileid."&index=".$index."&type=".gettype2($tmp3);} else {$tmp2=$fcombo."?fileid=".$fileid."&index=".$kk[2]."&type=".gettype2($tmp3);}}
else if (strpos(strtolower($ee)," src=")>0)   {$ee=substr($ee,0,strpos(strtolower($ee)," src=")+5);$tmp1=substr($cc[$dd],0,strlen($tmp2)-strlen($ee));$tmp2=$ee;if (strpos($ee," ")>0)                                        {$ee=substr($ee,0,strpos($ee," "));$tmp3=substr($tmp2,strpos($tmp2," ")).$tmp3;$tmp2=$ee;} else {$ee=substr($ee,0,strlen($ee)-1);$tmp3=substr($tmp2,strpos(" ")).$tmp3;$tmp2=$ee;}$kk=filelist($ee, $urls,$xurls,$index,$path,$c_url,$c_proto,$c_port); if ($kk[0]) {$urls.=$kk[1];$xurls.=gettype2($tmp3)."\n";$index++;$tmp2=$fcombo."?fileid=".$fileid."&index=".$index."&type=".gettype2($tmp3);} else {$tmp2=$fcombo."?fileid=".$fileid."&index=".$kk[2]."&type=".gettype2($tmp3);}}
$tmp1="";$tmp2="";$tmp3=$cc[$dd];
$ee=substr($cc[$dd],0,strpos($cc[$dd],">"));$tmp2=$ee;$tmp3=substr($cc[$dd],strpos($cc[$dd],">"));$tmp1="";
     if (strpos(strtolower($ee)," srcset=\"")>0) {$ee=substr($ee,  strpos(strtolower($ee)," srcset=\"")+9);$tmp1=substr($cc[$dd],0,strlen($tmp2)-strlen($ee));$tmp2=$ee;$ee=substr($ee,0,strpos($ee,"\""));$tmp3=substr($tmp2,strpos($tmp2,"\"")).$tmp3;$tmp2=$ee;$kk=filelist2($ee, $urls,$xurls,$index,$path,$c_url,$c_proto,$c_port,$fcombo,$fileid);$urls=$kk[0];$tmp2=$kk[1];$index=$kk[2];$xurls=$kk[3];}
...
echo "video found";
     if (strpos(strtolower($ee)," content=\"")>0) {$ee=substr($ee,  strpos(strtolower($ee)," content=\"")+10);$tmp1=substr($cc[$dd],0,strlen($tmp2)-strlen($ee));$tmp2=$ee;$ee=substr($ee,0,strpos($ee,"\""));$tmp3=substr($tmp2,strpos($tmp2,"\"")).$tmp3;$tmp2=$ee;$kk=filelist($ee, $urls,$xurls,$index,$path,$c_url,$c_proto,$c_port); if ($kk[0]) {$urls.=$kk[1];$xurls.="vid\n";$index++;$tmp2=$fcombo."?fileid=".$fileid."&index=".$index."&type=vid";} else {$tmp2=$fcombo."?fileid=".$fileid."&index=".$kk[2]."&type=vid";}}
else if (strpos(strtolower($ee)," content='")>0)  {$ee=substr($ee,  strpos(strtolower($ee)," content='")+10);$tmp1=substr($cc[$dd],0,strlen($tmp2)-strlen($ee));$tmp2=$ee; $ee=substr($ee,0,strpos($ee,"'"));$tmp3=substr($tmp2,strpos($tmp2,"'")).$tmp3;$tmp2=$ee;$kk=filelist($ee, $urls,$xurls,$index,$path,$c_url,$c_proto,$c_port); if ($kk[0]) {$urls.=$kk[1];$xurls.="vid\n";$index++;$tmp2=$fcombo."?fileid=".$fileid."&index=".$index."&type=vid";} else {$tmp2=$fcombo."?fileid=".$fileid."&index=".$kk[2]."&type=vid";}}
...
if (startsWith(strtolower($ee),"base href=\""))     {$ee=substr($ee,strpos(strtolower($ee),"a href=\"")+11);$tmp1=substr($cc[$dd],0,strlen($tmp2)-strlen($ee));$tmp2=$ee;$ee=substr($ee,0,strpos($ee,"\""));$tmp3=substr($tmp2,strpos($tmp2,"\"")).$tmp3;$tmp2=$ee;$kk=filelist($ee, $urls,$xurls,$index,$path,$c_url,$c_proto,$c_port); if ($kk[0]) {$urls.=$kk[1];$xurls.="href\n";$index++;$tmp2=$fcombo."?fileid=".$fileid."&index=".$index."&type=href";} else {$tmp2=$fcombo."?fileid=".$fileid."&index=".$kk[2]."&type=href";}}
else if (startsWith(strtolower($ee),"base href='")) {$ee=substr($ee,strpos(strtolower($ee),"a href='")+11);$tmp1=substr($cc[$dd],0,strlen($tmp2)-strlen($ee));$tmp2=$ee; $ee=substr($ee,0,strpos($ee,"'")) ;$tmp3=substr($tmp2,strpos($tmp2,"'")).$tmp3;$tmp2=$ee;$kk=filelist($ee, $urls,$xurls,$index,$path,$c_url,$c_proto,$c_port); if ($kk[0]) {$urls.=$kk[1];$xurls.="href\n";$index++;$tmp2=$fcombo."?fileid=".$fileid."&index=".$index."&type=href";} else {$tmp2=$fcombo."?fileid=".$fileid."&index=".$kk[2]."&type=href";}}
else if (startsWith(strtolower($ee),"base href="))  {$ee=substr(ee,strpos(strtolower($ee),"base href=")+10);$tmp1=substr($cc[$dd],0,strlen($tmp2)-strlen($ee));$tmp2=$ee;if (strpos(ee," ")>0)                               {$ee=substr($ee,0,substr($ee," "));;$tmp3=substr($tmp2,strpos($tmp2," ")).$tmp3;$tmp2=$ee;} else {$ee=substr($ee,0,strlen($ee)-1);$tmp3=substr($tmp2,strpos($tmp2," ")).$tmp3;$tmp2=$ee;}$bpath=$ee;$path=$bpath;   $kk=filelist($ee, $urls,$xurls,$index,$path,$c_url,$c_proto,$c_port); if ($kk[0]) {$urls.=$kk[1];$xurls.="href\n";$index++;$tmp2=$fcombo."?fileid=".$fileid."&index=".$index."&type=href";} else {$tmp2=$fcombo."?fileid=".$fileid."&index=".$kk[2]."&type=href";}}
}
...
//function filelist($ee, $urls,$xurls,$index,$path,$c_url,$proto,$port)
if      (strpos(strtolower($ee)," href=\"")>0) {$ee=substr($ee,strpos(strtolower($ee)," href=\"")+7);$tmp1=substr($cc[$dd],0,strlen($tmp2)-strlen($ee));$tmp2=$ee;$ee=substr($ee,0,strpos($ee,"\""));$tmp3=substr($tmp2,strpos($tmp2,"\"")).$tmp3;$tmp2=$ee;$kk=filelist($ee, $urls,$xurls,$index,$path,$c_url,$c_proto,$c_port); if ($kk[0]) {$urls.=$kk[1];$xurls.=$casetype."\n";$index++;$tmp2=$fcombo."?fileid=".$fileid."&index=".$index."&type=".$casetype;} else {$tmp2=$fcombo."?fileid=".$fileid."&index=".$kk[2]."&type=".$casetype;}}
else if (strpos(strtolower($ee)," href='")>0)   {$ee=substr($ee,strpos(strtolower($ee)," href='")+7);$tmp1=substr($cc[$dd],0,strlen($tmp2)-strlen($ee));$tmp2=$ee; $ee=substr($ee,0,strpos($ee,"'")) ;$tmp3=substr($tmp2,strpos($tmp2,"'")).$tmp3;$tmp2=$ee;$kk=filelist($ee, $urls,$xurls,$index,$path,$c_url,$c_proto,$c_port); if ($kk[0]) {$urls.=$kk[1];$xurls.=$casetype."\n";$index++;$tmp2=$fcombo."?fileid=".$fileid."&index=".$index."&type=".$casetype;} else {$tmp2=$fcombo."?fileid=".$fileid."&index=".$kk[2]."&type=".$casetype;}}
else if (strpos(strtolower($ee)," href=")>0)    {$ee=substr($ee,strpos(strtolower($ee)," href=")+6);$tmp1=substr($cc[$dd],0,strlen($tmp2)-strlen($ee));$tmp2=$ee;if (strpos($ee," ")>0)                         {$ee=substr($ee,0,strpos($ee," "));$tmp3=substr($tmp2,strpos($tmp2," ")).$tmp3;$tmp2=$ee;} else {$ee=substr($ee,0,strlen($ee)-1);$tmp3=substr($tmp2,strpos($tmp2," ")).$tmp3;$tmp2=$ee;} $kk=filelist($ee, $urls,$xurls,$index,$path,$c_url,$c_proto,$c_port); if ($kk[0]) {$urls.=$kk[1];$xurls.=$casetype."\n";$index++;$tmp2=$fcombo."?fileid=".$fileid."&index=".$index."&type=".$casetype;} else {$tmp2=$fcombo."?fileid=".$fileid."&index=".$kk[2]."&type=".$casetype;}}
}
...
$kk=filelist($ee, $urls,$xurls,$index,$path,$c_url,$c_proto,$c_port);
...
{if (strpos(strToLower($path),"/status/")>0) {
...
$kk=parsedata($ll,(startsWith($proto,"ssl")?"https://":"http://"),$url,":".$port,$path,$index,$fcombo,$fileid,$urls, $xurls,true, false, $istwitter,$isvideo);
$urls=$kk[0];
...
//echo "<br>rr".$b.":".$rr[$b]." ".strlen($rr[$b])."<br>";
//echo "<br>video:".$video." ".strlen($video)."<br>";
//echo "<br>".count($rr)."<br>";
...
//if ((strpos($rr[$b],$badwords2[$i])>0 || startsWith($rr[$b],$badwords2[$i])) && $badwords2[$i]!=="www.google.com") {
...
$iscss=false;
$ext=$rr[$b];
if (strpos($ext,"?")>0) {//echo "helloext1";
$ext=substr($ext,0,strpos($ext,"?"));}
//echo "<br>ext".$ext."</br>";
if (strpos($ext,".")>0) {//echo "helloext2";
$ext=substr($ext,strrpos($ext,".")+1);//echo "<br>ext".$ext."</br>";
...
$kk=parsedata($ll,(startsWith($proto,"ssl")?"https://":"http://"),$url,":".$port,$path,$index,$fcombo,$fileid,$urls,$xurls,$doreplace,$iscss, $istwitter,$isvideo);
$urls=$kk[0];
$codes[$codeindex]=$kk[1];
$index=$kk[2];
$xurls=$kk[3];
...
$kk=parsedata($ll,(startsWith($proto,"ssl")?"https://":"http://"),$url,":".$port,$path,$index,$fcombo,$fileid,$urls,$xurls,true,$iscss, $istwitter,$isvideo);
$urls=$kk[0];
$index=$kk[2];
$xurls=$kk[3];
$codes[$codeindex]=$kk[1];
